...
```svelte
<script lang="ts">
	import { Slider, type SliderProps, getters } from "melt/builders";
	import type { ComponentProps } from "melt";

  const { value = $bindable(50), ...rest }: ComponentProps<SliderProps> = $props();
...
<script lang="ts">
	...
	import { type SliderProps, getters } from "melt/builders";
	import type { ComponentProps } from "melt";
