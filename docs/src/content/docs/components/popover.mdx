...
<script lang="ts">
	...
	function createTriggerHandler(triggerKey: string) {
		return (e: Event) => {
...
<button {...popover.trigger} onclick={createTriggerHandler('user')}>
	User Profile
</button>
<button {...popover.trigger} onclick={createTriggerHandler('notifications')}>
	Notifications
</button>
<button {...popover.trigger} onclick={createTriggerHandler('help')}>
	Help
</button>
...
<Popover>
	{#snippet children(popover)}
		<button {...popover.trigger} onclick={() => activeTrigger = 'user'}>
			User Profile
		</button>
		<button {...popover.trigger} onclick={() => activeTrigger = 'notifications'}>
			Notifications
		</button>
		<button {...popover.trigger} onclick={() => activeTrigger = 'help'}>
			Help
		</button>
